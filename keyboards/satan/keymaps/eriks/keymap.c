...
[_BL] = KEYMAP(
  ...
  KC_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,    KC_T,    KC_Y,    KC_U,     KC_I, KC_O,    KC_P,    KC_LBRC, KC_RBRC, MO(_FL), \
...
[_FL] = KEYMAP(
  ...
  _______, _______, KC_UP,   _______, _______, _______, _______, _______,  KC_INS, KC_PSCR, KC_MPLY, KC_VOLU, KC_PGUP, _______, \
  KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_VOLD, KC_PGDN, _______, \
...
[_HL] = KEYMAP(
  ...
  _______, TG(_AL), _______, _______, _______, BL_INC , _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, BL_DEC, BL_TOGG,     F(0), _______, _______, _______, _______, _______, _______, \
